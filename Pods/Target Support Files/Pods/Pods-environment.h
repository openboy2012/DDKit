...
// DDModel
#define COCOAPODS_POD_AVAILABLE_DDModel
#define COCOAPODS_VERSION_MAJOR_DDModel 0
#define COCOAPODS_VERSION_MINOR_DDModel 1
#define COCOAPODS_VERSION_PATCH_DDModel 1
